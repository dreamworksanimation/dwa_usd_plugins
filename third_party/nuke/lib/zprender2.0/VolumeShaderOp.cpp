...
/// @file zprender/VolumeShaderOp.cpp
///
/// @author Jonathan Egstad


#include "VolumeShaderOp.h"
...
/*!
*/
VolumeShaderOp::VolumeShaderOp(::Node* node) :
    VolumeShader(),
...
//!
/*static*/ const char* VolumeShaderOp::zpClass() { return "zpVolumeShaderOp"; }

/*!
*/
void
VolumeShaderOp::addVolumeShaderOpIdKnob(DD::Image::Knob_Callback f)
{
#ifdef ZPR_USE_KNOB_RTTI
    // HACK!!!! Define a hidden knob that can be tested instead of dynamic_cast:
    int dflt=0;
    Int_knob(f, &dflt, VolumeShaderOp::zpClass(), DD::Image::INVISIBLE);
...
/*virtual*/
void
VolumeShaderOp::knobs(DD::Image::Knob_Callback f)
{
    addVolumeKnobs(f);
    Divider(f);
    addFalloffKnobs(f);
...
/*virtual*/
void
VolumeShaderOp::addVolumeKnobs(DD::Image::Knob_Callback f)
{
    addVolumeShaderOpIdKnob(f);
...
/*virtual*/
void
VolumeShaderOp::addFalloffKnobs(DD::Image::Knob_Callback f)
{
...
/*virtual*/
void
VolumeShaderOp::addNoiseKnobs(DD::Image::Knob_Callback f)
{
...
/*virtual*/
void
VolumeShaderOp::_validate(bool for_real)
{
    if (!for_real)
        return;
...
*/
bool
VolumeShaderOp::getVolumeIntersections(zpr::RayShaderContext&          stx,
                                     ...
                                     double&                         vol_segment_max) const
{
    ...
    //std::cout << "VolumeShaderOp::getVolumeIntersections(" << this << "): Rtx[" << stx.Rtx << "]";
...
/*virtual*/
bool
VolumeShaderOp::volumeMarch(zpr::RayShaderContext&                stx,
                          double                                tmin,
                          double                                tmax,
                          double                                depth_min,
                          double                                depth_max,
...
#endif
#endif
    //std::cout << "VolumeShaderOp::volumeMarch(" << this << "): Rtx[" << stx.Rtx << "]";
...
// end of zprender/VolumeShaderOp.cpp
