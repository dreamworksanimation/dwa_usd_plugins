...
/// @file zprender/VolumeMaterialOp.h
///
/// @author Jonathan Egstad


#ifndef zprender_VolumeMaterialOp_h
#define zprender_VolumeMaterialOp_h
...
*/
class ZPR_EXPORT VolumeMaterialOp : public VolumeShader,
                                  public DD::Image::Material
{
  ...
  public:
    const char* Class()     const { return "VolumeMaterialOp"; }
    const char* node_help() const { return ""; }

    //! A parent node is not required.
    VolumeMaterialOp(::Node* node=NULL);

    //! Must have a virtual destructor!
    virtual ~VolumeMaterialOp();


    //!
    /*virtual*/ VolumeMaterialOp* isVolumeMaterialOp() { return this; }


    //!
    static const char* zpClass();

    /*! !!HACK ALERT!! This adds an invisible 'zpVolumeMaterialOp' knob
        that's used to identify a VolumeMaterialOp-derived Op to other plugins.
        ...
        pointer to VolumeMaterialOp*.

        Atm if this knob doesn't exist then the _evaludate*() methods will
        not be called since the node will not be recognized as a VolumeMaterialOp!
    */
    void addVolumeMaterialOpIdKnob(DD::Image::Knob_Callback f);


    //!
    /*virtual*/ void knobs(DD::Image::Knob_Callback f);
    //!
    virtual void addVolumeKnobs(DD::Image::Knob_Callback f);
    //!
    virtual void addFalloffKnobs(DD::Image::Knob_Callback f);
    //!
    virtual void addNoiseKnobs(DD::Image::Knob_Callback f);
    ...
    //! Allocate and return a RayShader object. Calling object takes ownership of pointer. Must implement.
    virtual VolumeShader* createShader(const RenderContext& rtx)=0;
...
// end of zprender/VolumeMaterialOp.h
